...
def create_model():
    ...
    model = SpectrumModel(num_classes=NUM_CLASSES, pretrained=True).to(DEVICE)
...
def main():
    ...
    # 최종 모델 저장
    torch.save(model.state_dict(), 'checkpoints/spectrum_model_final.pth')
    print("\n학습 완료!")
...
if __name__ == "__main__":
    ...
    IMG_HEIGHT = 192
    IMG_WIDTH = 1024
    TRAIN_DIR = 'D:/0_subby_works/spectrogram_training_data_20221006/dataset/train'
    VAL_DIR = 'D:/0_subby_works/spectrogram_training_data_20221006/dataset/val'
    DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")

    # # for debug
    # visualize_samples_check(img_dir='D:/0_subby_works/spectrogram_training_data_20221006/dataset/train', num_samples=2)
