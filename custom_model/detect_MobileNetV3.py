...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights", default="checkpoints/final_spectrum_model.pth", help="모델 가중치 파일 경로")
    parser.add_argument("--img-dir", default='./test_data', help="이미지 디렉토리 경로")
